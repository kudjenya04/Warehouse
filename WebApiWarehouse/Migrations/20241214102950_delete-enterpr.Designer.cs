...
namespace WebApiWarehouse.Migrations
{
    ...
    [Migration("20241214102950_delete-enterpr")]
    partial class deleteenterpr
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApiWarehouse.Models.Order", b =>
                {
                    ...
                    b.HasOne("WebApiWarehouse.Models.Enterprise", null)
                        .WithMany("Orders")
                        .HasForeignKey("EnterpriseIdE");
