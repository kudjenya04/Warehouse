...
namespace WebApiWarehouse.Migrations
{
    ...
    [Migration("20241213202736_first-migration")]
            ...
            modelBuilder.Entity("WebApiWarehouse.Models.Order", b =>
                {
                    ...
                    b.HasOne("WebApiWarehouse.Models.Enterprise", "Enterprise")
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_Orders_Enterprises");
                    ...
                    b.HasOne("WebApiWarehouse.Models.Product", null)
                        .WithMany("Orders")
                        .HasForeignKey("ProductIdP");
